...
const PopupSendToMentor = (props) => {
  const { isVisiblePopup, setIsVisiblePopup, handleClosePopup, group } = props;
  const { loadingAnimationStore, groupStore, mentorStore, currentUser } =
  ...
  const handleSend = async () => {
    try {
      ...
      message.error(err.en || "Submit group failed!");
    } finally {
      loadingAnimationStore.showSpinner(false);
    }
  };
...
export default PopupSendToMentor;
